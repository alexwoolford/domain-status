            ...
            if count > 0 {
                ...
                Some(TimingSummary {
                    ...
                    averages: TimingMetrics {
                        ...
                        body_read_ms: micros_to_ms(avg.body_read_us),
                        html_parse_ms: micros_to_ms(avg.html_parse_us),
                        secret_scan_ms: micros_to_ms(avg.secret_scan_us),
                        tech_detection_ms: micros_to_ms(avg.tech_detection_us),
                        late_tech_ms: micros_to_ms(avg.late_tech_us),
                        external_script_fetch_ms: micros_to_ms(avg.external_script_fetch_us),
                        external_script_analysis_ms: micros_to_ms(avg.external_script_analysis_us),
                        sqlite_write_ms: micros_to_ms(avg.sqlite_write_us),
